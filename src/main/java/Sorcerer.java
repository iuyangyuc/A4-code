...
public class Sorcerer implements Hero {
    ...
    public Sorcerer(String name, double mana, double strength, double agility, double dexterity, double Gold, double level, String type) {
        this.name = name;
        this.mana = mana;
    ...
    public void levelUp() {
        ...
        this.strength = gameUtlity.keep2(this.strength * 1.05);
