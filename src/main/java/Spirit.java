...
public class Spirit implements Monster {
    ...
    public Spirit(String name, int level, double hp, double damage, double defense, double dodgeChance) {
        this.name = name;
        this.level = level;
        this.hp = level * 100;
        this.damage = damage;
    ...
    public Spirit(ArrayList<Object> attributes) {
