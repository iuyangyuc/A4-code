...
public class Paladin implements Hero {
    ...
    public Paladin(String name, double mana, double strength, double agility, double dexterity, double Gold, double level, String type) {
        this.name = name;
        this.mana = mana;
    ...
    public Paladin(ArrayList<Object> attributes) {
