...
public class Exoskeleton implements Monster {
    ...
    public Exoskeleton(String name, int level, double hp, double damage, double defense, double dodgeChance) {
        this.name = name;
        this.level = level;
        this.hp = level * 100;
        this.damage = damage;
    ...
    public Exoskeleton(ArrayList<Object> attributes) {
    ...
    public void levelUp(int increase) {
        this.level += increase;
        this.hp = level * 100;
        this.damage += gameUtlity.keep2(this.damage * Math.pow(1.05, increase));
        this.defense += gameUtlity.keep2(this.defense * Math.pow(1.1, increase));
